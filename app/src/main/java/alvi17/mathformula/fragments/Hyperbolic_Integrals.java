 ...
 */
public class Hyperbolic_Integrals extends Fragment{

    public Hyperbolic_Integrals()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Hyperbolic Integrals");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Hyperbolic_Integrals.html");
            }
        });
        return rootView;
    }
