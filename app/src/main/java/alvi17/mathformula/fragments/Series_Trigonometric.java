 ...
 */
public class Series_Trigonometric extends Fragment{
    public Series_Trigonometric()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Trigonometric Series");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Trigonomtric_Series.html");
            }
        });
        return rootView;
    }
