 ...
 */
public class Inverse_Hyperbolic extends Fragment{


    public Inverse_Hyperbolic()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Inverse Hyperbolic Integrals");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Inverse_Hyperbolic.html");
            }
        });
        return rootView;
    }
