 ...
 */
public class Definite_Exponential extends Fragment{
    public Definite_Exponential()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Exponentional Functions");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Definite_Exponential.html");
            }
        });
        return rootView;
    }
