 ...
 */
public class LogarithmicIntegrals extends Fragment{
    public LogarithmicIntegrals()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Logarithmic Integrals");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/LogarithmicIntegrals.html");
            }
        });
        return rootView;
    }
