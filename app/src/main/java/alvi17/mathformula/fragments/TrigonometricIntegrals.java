 ...
 */
public class TrigonometricIntegrals extends Fragment{
    public TrigonometricIntegrals()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Trigonometric Integrals");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/TrigonomtericIntegrals.html");
            }
        });
        return rootView;
    }
