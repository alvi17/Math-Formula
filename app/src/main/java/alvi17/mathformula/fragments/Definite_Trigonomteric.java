 ...
 */
public class Definite_Trigonomteric extends Fragment{
    public Definite_Trigonomteric()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Trigonometric Funtions");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Definite_Trigonometry.html");
            }
        });
        return rootView;
    }
