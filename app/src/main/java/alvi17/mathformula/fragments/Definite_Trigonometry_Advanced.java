 ...
 */
public class Definite_Trigonometry_Advanced extends Fragment{
    public Definite_Trigonometry_Advanced()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Advanced Trigonometry Formulas");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Definite_Trigonomtery_Advanced.html");
            }
        });
        return rootView;
    }
