 ...
 */
public class Series_Inverse_Tri extends Fragment{
    public Series_Inverse_Tri()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Inverse Trigonometric Series");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Inverse_Tri_Series.html");
            }
        });
        return rootView;
    }
