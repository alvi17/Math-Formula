 ...
 */
public class Definite_Logarithmic extends Fragment {
    public Definite_Logarithmic()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Logarithmic Functions");
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                w.loadUrl("file:///android_asset/test/Definite_Logarithmic.html");
            }
        });
        return rootView;
    }
